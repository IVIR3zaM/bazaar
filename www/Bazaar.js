...
var Bazaar = {
  show: function(packageName, successCallback, errorCallback) {
    ...
    exec(success, error, "Bazaar", "show", [packageName]);
  },
  rate: function(packageName, successCallback, errorCallback) {
    var success = (typeof successCallback == "function" ? successCallback : function(){});
    var error = (typeof errorCallback == "function" ? errorCallback : function(){});
    exec(success, error, "Bazaar", "rate", [packageName]);
  },
